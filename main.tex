...
\usepackage{listings}
\begin{document}
\title{Assessment of unprecedented environmental events: impacts on air pollution in Northeast Mexico}
%\author*[1]{
%\fnm{Adriana}
%\sur{Ipi\~na}
...
%\author[2]{
%\fnm{Constanza}
%\sur{Z\'u\~niga-Villarreal}
%}\email{czuniga@cicese.edu.mc}
%\author[3]{
%\fnm{Gamaliel}
%\sur{L\'opez-Padilla}
%}\email{giovanni.lopez@cimat.mx}
%\author[4]{
%\fnm{Jair Rafael}
%\sur{Carrillo \'Avila}
%}\email{jrcarrillo8927@gmail.com}
%\author[5]{
%\fnm{Michel}
%\sur{Grutter}
%}\email{grutter@unam.mx}
%\affil*[1]{
%\orgname{Instituto de F\'isica Rosario (CONICET-UNR)},
%\orgaddress{27 de Febrero 210 BIS},
%\city{Rosario},
%\postcode{2000},
%\state{Santa Fe},
%\country{Argentina}
%}
%\affil[2]{
%\orgname{Centro de Investigación Cient\'ifica y de Educación Superior de Ensenada (CONAHCYT)},
%\orgaddress{Carretera Ensenada - Tijuana 3918},
%\city{Ensenada},
%\postcode{22860},
...
%}
%\affil[3]{
%\orgname{Centro de Investigación en Matem\'aticas A.C. (CONAHCYT)},
%\orgaddress{De Jalisco s/n},
%\city{Guanajuato},
%\postcode{36023},
%\state{Guanajuato},
%\country{M\'exico}
%}
%\affil[4]{
%\orgname{Agencia de la Calidad del Aire, Secretar\'ia de Medio Ambiente de Nuevo León},
%\orgaddress{Washington 2000 Ote},
%\city{Monterrey},
%\postcode{64010},
%\state{Nuevo León},
%\country{M\'exico}
%}
%\affil[5]{
%\orgname{Instituto de Ciencias de la Atm\'osfera y Cambio Clim\'atico, Universidad Nacional Autónoma de M\'exico},
%\orgaddress{Investigación Cient\'ifica s/n, CU},
%\city{Coyoacán},
%\postcode{04510},
...
%%Research highlights
%\begin{highlights}
%\item Climate change drives unprecedented meteorological events.
%\item Extraordinary environmental conditions have a considerable impact on air pollution.
%\item Extreme weather episodes, transatlantic dust, and wildfires mask the changes in urban PM\textsubscript{10}.
%\item Detrended and deseasonalized pollutant data reveal the real changes due to mobility reduction.
%\end{highlights}
\keywords{
	Air pollutants,
	Extreme weather,
...
\begin{figure}[htb]
	\begin{center}
		\includegraphics[width=\linewidth]{figures/amm_tabla.png}
...
\begin{figure}[htb]
	\begin{center}
		\includegraphics[width=\linewidth]{figures/monthly_fourier.pdf}
...
\begin{figure}[htb]
	\begin{center}
		\includegraphics[width=\linewidth]{figures/pollutant_anomalies.pdf}
