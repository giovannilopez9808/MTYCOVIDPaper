...
\usepackage{listings}
\begin{document}
\title[Climate-driven unprecedented events: impacts on Monterrey urban air pollution]{Climate-driven unprecedented events: impacts on Monterrey urban air pollution}
\author*[1]{
	\fnm{Adriana}
	\sur{Ipi\~na}
...
\affil[3]{
	...
	\orgaddress{De Jalisco s/n, Valenciana},
	\city{Guanajuato},
	\postcode{36023},
	\state{Guanajuato},
	\country{M\'exico}
...
\affil[5]{
	\orgname{Instituto de Ciencias de la Atmósfera y Cambio Clim\'atico, Universidad Nacional Autónoma de M\'exico},
